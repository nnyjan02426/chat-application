...
const Login = ({ setUser, setShowEdit }) => {
            ...
            <div id='login' className='info-box'>
                <div id='login-info' className='input-info'>
                    ...
                    <div id='login-buttons' className='buttons'>
                        ...
                        <p id='force' className='force-button' onClick={(e) => {setUser(true); setShowEdit(true)}}>
                            show edit
                        </p>

                        <p id='force' className='force-button' onClick={(e) => {setUser(true); setShowEdit(false)}}>
                            show chatroom
                        </p>
                    </div>
                </div>
